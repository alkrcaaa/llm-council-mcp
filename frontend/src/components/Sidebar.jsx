      ...
      <div className="sidebar-header">
        ...
        <div className="sidebar-new-actions">
          <button
            ...
            onClick={() => onNewConversation?.(null, null, 'roundtable')}
            title="Start an organic Round-Table group chat"
          >
            New Chat
          </button>
          <button
            type="button"
            className="new-deliberation-btn"
            onClick={() => onNewConversation?.(null, null, 'deliberation')}
            title="Start a formal 3-stage Council Deliberation"
          >
            Council
          </button>
        </div>
